      ...
      <div className="cart-items">
        ...
        <div className="cart-item">
          <img 
            ...
            className="lab-image" 
          />
          <h3>Erlenmeyer Flask </h3>
          <p>An Erlenmeyer flask is a conical shaped container with a flat bottom and a cylindrical neck. The narrow neck of the flask helps to prevent the escape of fumes and vapors, while the wide base helps in stability. The flask is used for mixing, heating, and holding liquids.</p>
        </div>
        <div className="cart-item">
          <img 
        ...
        <div className="cart-item">
          ...
          />
          <h3>Thermometer</h3>
          <p>A thermometer is an instrument used to measure temperature. In the laboratory, thermometers are usually used to measure the temperature of liquids or gases. There are different types of thermometers, including digital and mercury thermometers, and they come in various sizes.</p>
        </div>
        <div className="cart-item">
          <img 
        ...
        <div className="cart-item">
          <img 
            ...
            className="lab-image" 
          />
          <h3>Separatory Funnel</h3>
          <p>A separatory funnel, also known as a separation funnel, is a laboratory apparatus used to separate immiscible liquids. It consists of a funnel with a stopcock valve at the bottom and is used to separate liquids based on their densities. Separatory funnels are commonly used in organic chemistry for extractions and purifications.</p>
        </div>
        <div className="cart-item">
          <img 
          ...
          />
          <h3>Pipette</h3>
          <p>A pipette is a laboratory tool used to measure and transfer small volumes of liquid. It is a narrow tube made of glass or plastic with a bulbous end. The pipette’s bulb is used to draw liquid up into the tube, and the narrow tip is used to dispense precise amounts of liquid.</p>
        </div>
        <div className="cart-item">
          <img 
          ...
          />
          <h3>Hot Plate</h3>
          <p>The instrument that are used to measure the heat absorbed or released during a chemical reaction is called calorimeter.</p>
        </div>
      </div>
      <Footer/>
    </div>
